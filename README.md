...
I'm a Python newbie. Added features
* new option `--frame_mod`: show every n-th frame
* new key controls
  * 'q'uit
  * 'p'ause or ' ' for - well - Pause / Resume
  * 'f'orward / 'r'ewind for files only (not for streams)
  * '+' zoom in
  * '-' zoom out
